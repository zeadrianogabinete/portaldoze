          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="mx-4 max-w-md rounded-xl bg-white p-6 shadow-lg">
              ...
              <div className="mt-4 flex justify-end gap-3">
                <button type="button" onClick={() => setShowDeleteConfirm(false)} className="rounded-lg border border-[var(--color-neutral-200)] px-4 py-2 text-sm font-medium text-[var(--color-neutral-700)]">Cancelar</button>
                <button
                  type="button"
