  ...
  return (
    <PageContainer>
      ...
      <motion.div
        ...
        className="mb-8 overflow-hidden rounded-xl border border-primary-200/20 bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 p-6 text-white relative shadow-2xl shadow-primary-900/20"
      >
        ...
        <div className="relative z-10 flex flex-wrap items-center justify-between gap-8">
          <div className="max-w-2xl">
            <div className="mb-4 inline-flex items-center gap-2.5 rounded-md bg-white/10 px-3 py-1 text-[11px] font-bold uppercase tracking-widest backdrop-blur-md border border-white/10">
              <Zap size={14} className="text-amber-400" />
              Painel Estratégico · Mandato 2026
            </div>
            <h1 className="font-heading text-2xl font-bold lg:text-4xl tracking-tight leading-tight">
          ...
          <div className="flex flex-col gap-3">
            <Badge className="border-white/10 bg-white/10 text-white backdrop-blur-md px-3 py-1.5 rounded-lg">
              {unreadCount > 0 ? `${unreadCount} Pendências Críticas` : 'Zero Pendências'}
            </Badge>
            <Badge className="border-emerald-400/20 bg-emerald-500/20 text-emerald-300 backdrop-blur-md px-3 py-1.5 rounded-lg">
            ...
            {featureCards.map((card) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-lg bg-primary-50 text-primary-500 border border-primary-100">
                  ...
                  {card.disabled ? (
                    ...
                    <Link
                      to={card.href}
                      className="inline-flex items-center gap-2 rounded-lg bg-primary-500 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-primary-500/25 transition-all hover:bg-primary-600 hover:-translate-y-0.5"
                    >
